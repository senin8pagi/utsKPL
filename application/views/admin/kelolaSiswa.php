            <div class='container-fluid'>
                ...
                <!-- DataTables Example -->
                <div class="card mb-3">
                    <div class="card-header"><i class="fas fa-table"></i> Tabel Siswa</div>
                    <div class="card-body">
                    <a href="<?=base_url('kelola/siswa/tambah')?>" class="btn btn-success mb-3">Tambah <i class="fas fa-pen"></i></a>
